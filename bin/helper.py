...
This script should be invoked only by the signed `chatgpt-codex-imessage-helper`
...
PRODUCT_ID = os.environ.get("IMESSAGE_PRODUCT_ID", "chatgpt-codex-imessage")
...
def action_status(params, conn, contacts, privacy_policy):
    ...
    return {
        ...
        "launchd_label": "com.jeffhuber.chatgpt-codex-imessage",
